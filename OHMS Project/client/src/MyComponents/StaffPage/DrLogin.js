...
class DrLogin extends Component {
  ...
  getDoctorIdByEmail(email) {
    ...
    DoctorService.getDoctorByEmail(email).then((res) => {
      ...
      this.setState({ did: res.data.did });
          ...
          <div className="Center">
            <div className="Centerinside lgradient">
              ...
              <form className="form">
                ...
                <br />
                <div className="d-grid gap-2 d-md-flex justify-content-md-end ; fplogin">
                  <Link to="/ForgotPassword" className="btn btn-primary me-md-2 title">
                    ForgotPassword
                  </Link>
                </div>
